...
- Semana 1: Selección del programa y análisis del problema.
- Semana 2: Diseño del sistema y diagramas.
- Semana 3: Entrega del Autónomo 1.
- Semana 4: Configuración del entorno e inicio del desarrollo.
- Semana 5: Implementación de funciones principales del juego.
...
Se recibieron observaciones para mejorar la lógica del programa, la organización del código y la presentación del juego.

Se realizaron correcciones en la detección de colisiones, estructura del código y funcionamiento general del sistema.

Finalmente, se dejó el programa listo para su ejecución y presentación final. 
